...
namespace BikeHaus.Infrastructure.Migrations
{
    ...
    [Migration("20260706180245_AddReviewCampaign")]
    partial class AddReviewCampaign
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BikeHaus.Domain.Entities.EmailUnsubscribe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BikeHaus.Domain.Entities.Bicycle", b =>
                {
                    ...
                    b.Property<bool>("IsPublishedOnKleinanzeigen")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("IsPublishedOnWebsite")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BikeHaus.Domain.Entities.BicycleImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BikeHaus.Domain.Entities.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BikeHaus.Domain.Entities.NeueFahrrad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("Gangschaltung")
                        .HasMaxLength(50)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("NeueFahrraeder");
                });

            modelBuilder.Entity("BikeHaus.Domain.Entities.NeueFahrradImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BikeHaus.Domain.Entities.RenovationCost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("GemachteArbeit")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BikeHaus.Domain.Entities.RentalAccessory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BikeHaus.Domain.Entities.RentalBooking", b =>
                {
                    ...
                    b.Property<string>("AdminNotizen")
                        .HasMaxLength(1000)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("BuchungsNummer")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("BuchungsNummer")
                        .IsUnique();

                    b.ToTable("RentalBookings");
                });

            modelBuilder.Entity("BikeHaus.Domain.Entities.RentalBookingAccessory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BikeHaus.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.Property<DateTime>("ReservierungsDatum")
                        .HasColumnType("TEXT");

                    b.Property<string>("ReservierungsNummer")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BikeHaus.Domain.Entities.Sale", b =>
                {
                    ...
                    b.Property<bool>("Versand")
                        .HasColumnType("INTEGER");

                    b.Property<decimal>("VersandGebuehr")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("BikeHaus.Domain.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BikeHaus.Domain.Entities.NeueFahrradImage", b =>
                {
                    b.HasOne("BikeHaus.Domain.Entities.NeueFahrrad", "Fahrrad")
                        .WithMany("Images")
                        .HasForeignKey("NeueFahrradId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Fahrrad");
                });
            ...
            modelBuilder.Entity("BikeHaus.Domain.Entities.Reservation", b =>
                {
                    b.HasOne("BikeHaus.Domain.Entities.Bicycle", "Bicycle")
                        .WithOne("Reservation")
                        .HasForeignKey("BikeHaus.Domain.Entities.Reservation", "BicycleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("BikeHaus.Domain.Entities.Sale", "Sale")
                        .WithOne()
                        .HasForeignKey("BikeHaus.Domain.Entities.Reservation", "SaleId")
                        .OnDelete(DeleteBehavior.SetNull);
